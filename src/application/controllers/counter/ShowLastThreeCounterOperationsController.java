...
public class ShowLastThreeCounterOperationsController  implements Initializable {
	@FXML
	...
	public void setGuichetierId(Long id) {
		...
		List<Operation> ops = DaoPersonTable.getLastThreeOperationForCounter(this.guichetierId);
